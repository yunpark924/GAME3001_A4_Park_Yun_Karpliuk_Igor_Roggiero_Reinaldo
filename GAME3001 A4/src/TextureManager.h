...
public:
	...
	void Draw(const std::string& id, glm::vec2 position, const GameObject* go, double angle = 0, int alpha = 255, bool centered = false, SDL_RendererFlip flip = SDL_FLIP_NONE);
